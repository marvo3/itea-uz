...
class OAuth2CrmSymfonyService_dev extends OAuth2CrmAbstract
{
    ...
    public function __construct()
    {
        ...
        $urlToken = 'http://api.itea-crm-dev.demo.gns-it.com/oauth/v2/token';
        $urlOrder = 'http://api.itea-crm-dev.demo.gns-it.com/api/v1/proposal-pull/';
        $urlCallbackOrder = 'http://api.itea-crm-dev.demo.gns-it.com/api/v1/call-back/';
        $urlForResume = 'http://api.itea-crm-dev.demo.gns-it.com/api/v1/contact/putItea/';
