(function() {
    ...
    var tips = {
        name: document.querySelector('.form-validation__userName'),
        phone: document.querySelector('.form-validation__userPhone'),
        mail: document.querySelector('.form-validation__userEmail'),
        course: document.querySelector('.form-validation__course')
    };//the collection of elements that appears for user if he has entered wrong data
    ...
    function validate(key) {
        ...
        tips[key].style.display = passed[key] ? 'none' : 'block';
    }
