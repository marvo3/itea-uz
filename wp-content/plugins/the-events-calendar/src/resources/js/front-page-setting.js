...
jQuery( function( $ ) {
	...
	var obj                 = tribe_events_front_page_setting,
	    ...
	    check_value         = obj.check || '',
	    $show_on_front      = $( 'input[name="show_on_front"]' ),
	    $page_on_front      = $( '#page_on_front' ),
	    $events_page_option = $( '<option value="main_events_page">' + events_page_label + '</option>' ),
	    $nonce_field        = $( '<input type="hidden" name="set_main_events_page" value="' + check_value + '">' );
